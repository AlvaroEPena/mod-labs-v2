...
export const site = {
  ...
  description:
    "Seattle console modding and electronics repair: Xbox 360 RGH, Nintendo Switch modchips (OLED Kamikaze, V1/V2, Lite), PS4 installs, custom handheld Wii builds and board-level repair.",
