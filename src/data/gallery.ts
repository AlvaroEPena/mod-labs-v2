...
export const projects: Project[] = [
  ...
  { slug: "halo-xbox", title: "Custom Halo Edition Xbox", category: "custom",
    video: { src: "/media/halo-xbox.mp4", title: "Custom Halo Edition Xbox RGB lighting" },
    caption: "A custom RGB layout with a Bluetooth RGB controller that connects to phones. Flashed the sound chip to R2-D2 and swapped the ring-of-light LEDs." },
  { slug: "clear-rgb-xbox", title: "Clear RGB Xbox 360", category: "custom",
    caption: "An Xbox 360 slim in a clear shell with custom RGB lighting throughout." },
